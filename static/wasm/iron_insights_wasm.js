 ...
 * @param {number} lift_kg
 * @param {number} bodyweight_kg
 * @returns {number}
 */
 ...
 * @returns {string}
 */
export function calculate_strength_level_from_percentile(percentile) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.calculate_strength_level_from_percentile(percentile);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @param {number} dots_score
 * @returns {string}
 */
export function calculate_strength_level(dots_score) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.calculate_strength_level(dots_score);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @param {number} dots_score
 * @param {string} lift_type
 * @returns {string}
 */
export function calculate_strength_level_for_lift(dots_score, lift_type) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(lift_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.calculate_strength_level_for_lift(dots_score, ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function calculate_strength_level_for_lift_with_gender(dots_score, lift_type, is_male) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(lift_type, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.calculate_strength_level_for_lift_with_gender(dots_score, ptr0, len0, is_male);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function get_strength_level_color(level) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(level, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_strength_level_color(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('iron_insights_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
